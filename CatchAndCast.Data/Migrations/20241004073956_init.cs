        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductCharacteristic = table.Column<string>(type: "nvarchar(1500)", maxLength: 1500, nullable: true),
                    ...
                    CountRate = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CounterProducts = table.Column<int>(type: "int", nullable: false, defaultValue: 1)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    NameOfCharacteristic = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DescriptionOfCharacteristic = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
